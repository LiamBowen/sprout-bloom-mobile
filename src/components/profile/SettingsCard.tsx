  ...
  return (
    <Card className="p-4 sm:p-6 animate-slide-up overflow-hidden" style={{ animationDelay: "0.2s" }}>
      <div className="flex items-center mb-4 sm:mb-6">
        ...
        <h2 className="text-lg sm:text-xl font-semibold">Settings ⚙️</h2>
      </div>
      <p className="text-sm text-gray-600 mb-4 sm:mb-6">Manage your account, investments, and preferences.</p>
